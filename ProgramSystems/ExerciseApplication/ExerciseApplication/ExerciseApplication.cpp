...
INT_PTR CALLBACK    Task12(HWND, UINT, WPARAM, LPARAM);
INT_PTR CALLBACK    MessageBox(HWND, UINT, WPARAM, LPARAM);
    ...
    case WM_COMMAND:
        {
            ...
            case ID_TASK1_T11:
                ...
                break;
            case ID_TASK1_T12:
                DialogBox(hInst, MAKEINTRESOURCE(IDD_TASK12), hWnd, Task12);
                break;
            case IDM_ABOUT:
...
INT_PTR CALLBACK Task1(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        else if (LOWORD(wParam) == IDMESSAGEBOX)
        {
            DialogBox(hInst, MAKEINTRESOURCE(IDD_MESSAGEBOX), hDlg, MessageBox);
            return (INT_PTR)TRUE;
        }
        break;
    }
...
INT_PTR CALLBACK MessageBox(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    UNREFERENCED_PARAMETER(lParam);
    switch (message)
    {
...
INT_PTR CALLBACK Task12(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    UNREFERENCED_PARAMETER(lParam);
    switch (message)
    {
